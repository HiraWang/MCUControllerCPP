...
MainWindow::MainWindow(QWidget* parent)
  ...
  connect(ui->upper_view->exit_button, &QPushButton::released, this,
          &MainWindow::ToggleExitButton);
  connect(ui->upper_view->window_button, &QPushButton::released, this,
          &MainWindow::ToggleWindowButton);
  connect(ui->upper_view->load_config_button, &QPushButton::released, this,
          &MainWindow::ToggleLoadConfigButton);
  connect(ui->upper_view->menu_button, &QPushButton::released, this,
          &MainWindow::ToggleMenuButton);
  connect(ui->upper_view->console_button, &QPushButton::released, this,
          &MainWindow::ToggleConsoleButton);
  connect(ui->upper_view->result_dir_button, &QPushButton::released, this,
          &MainWindow::ToggleResultDirButton);
  connect(ui->upper_view->power_button, &QPushButton::released, this,
          &MainWindow::TogglePowerButton);
...
void MainWindow::mousePressEvent(QMouseEvent* event) {
  if (event->button() == Qt::RightButton) {
    ...
    QIcon icon_dialog =
        QIcon(QString::fromStdString(GetAbsPath(IMAGE_MET_MENU)));
    ...
    QIcon icon_console =
        QIcon(QString::fromStdString(GetAbsPath(IMAGE_MET_CONSOLE)));
    ...
    QIcon icon_config =
        QIcon(QString::fromStdString(GetAbsPath(IMAGE_MET_CONFIG)));
    ...
    QIcon icon_result =
        QIcon(QString::fromStdString(GetAbsPath(IMAGE_MET_RESULT)));
...
void MainWindow::ToggleConfigDirButton() {
  std::wstring config_dir =
      std::wstring(MONITOR_CONFIG_DIR.begin(), MONITOR_CONFIG_DIR.end());
  ShellExecute(nullptr, L"open", nullptr, nullptr, config_dir.c_str(),
               SW_SHOWNORMAL);
}
...
void MainWindow::ToggleDeviceComboBox() {
  QStandardItemModel* model = dynamic_cast<QStandardItemModel*>(
      ui->upper_view->mode_combo_box->model());
...
MainWindowController::MainWindowController() : window(nullptr) {}

MainWindowController::~MainWindowController() { delete window; }
