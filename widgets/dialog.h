...
class MetDialog : public QDialog {
 ...
 public:
  MetDialog(MetParaList* para_list, QWidget* parent = nullptr);
  virtual ~MetDialog();
  void Show();
  void Close();
 ...
 private:
  void SetupUi();
  void AddAttribute(MetPara para, QHBoxLayout* layout, MetLineEdit* line_edit,
                    bool is_editable, unsigned char* para_count);
  QVBoxLayout* layout;
  MetTextEdit* text;
