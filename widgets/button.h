...
class MetButtonStyle {
 public:
  MetButtonStyle(QString color_1 = COLOR_WHITE, QString color_2 = COLOR_WHITE,
...
class MetButton : public QPushButton {
 ...
 public:
  MetButton(MetButtonStyle style, QString name_default, QString name_pressed,
            int w, int h, QString icon_path_default = "",
            QString icon_path_pressed = "", QWidget* parent = nullptr);
  virtual ~MetButton();
