...
MetTree::MetTree(MetTreeStyle style, int w, int h, QWidget* parent)
    : style(style), menu(nullptr), QTreeWidget(parent) {
  LoadStyleSheet();
  ...
  QStringList list_2[2] = {{"rpm", "dir"}, {"freq", "pw", "voltage", "offset"}};
  QStringList list_3[2] = {{"rpm", ""}, {"Hz", "ms", "v", "v"}};
...
MetTreeStyle::MetTreeStyle(QString bkg_color, QString font_size,
                           QString font_color)
