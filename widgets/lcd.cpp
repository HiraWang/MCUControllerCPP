...
MetLcd::MetLcd(MetLcdStyle style, QString name, QString unit, int label_w,
               int label_h, int lcd_w, int lcd_h, QWidget* parent)
    : style(style),
      name(name),
      unit(unit),
      label_w(label_w),
...
MetLcdStyle::MetLcdStyle(QString bkg_color, QString border_color,
