...
MetButton::MetButton(MetButtonStyle style, QString name_default,
                     QString name_pressed, int w, int h,
                     QString icon_path_default, QString icon_path_pressed,
                     QWidget* parent)
    : style(style),
      ...
      QPushButton(parent),
      status(false) {
  if (icon_path_default.isEmpty() && icon_path_pressed.isEmpty()) {
...
MetButtonStyle::MetButtonStyle(QString color_1, QString color_2,
                               QString hover_color_1, QString hover_color_2,
                               QString pressed_color_1, QString pressed_color_2,
                               QString font_size, QString font_color)
    : color_1(color_1),
      color_2(color_2),
