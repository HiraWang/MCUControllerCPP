...
MetPumpChannel::MetPumpChannel(MetPumpChannelStyle met_style,
                               DeviceRegloIcc* reglo_icc, BYTE channel,
...
void MetPumpChannel::SetupUi() {
  ...
  MetLabel* dir_label =
      new MetLabel(label_style, "Direction:", 120, WIDGET_H, this);
  MetLabel* out_label =
      new MetLabel(label_style, "Pump State:", 120, WIDGET_H, this);
  ...
  dir_button = new MetButton(two_state_button_style, "CCW", "CW", BUTTON_W,
                             WIDGET_H, "", "", this);
...
MetPumpChannelStyle::MetPumpChannelStyle(QString bkg_color, QString font_size,
                                         QString font_color)
